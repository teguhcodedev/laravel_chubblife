...
Route::group(['middleware' => ['auth', 'checkRole:admin,kasir,manager,tmo,QA,customer,TMO,asisten manager']], function(){
	...
	Route::get('/account/getspv', 'UserManageController@getspv')->name('getspv');
    Route::get('/account/getmanager', 'UserManageController@getmanager')->name('getmanager');
	// > Akses
