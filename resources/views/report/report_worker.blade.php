            ...
            <table class="table table-custom">
              <thead>
                <tr>
                  ...
                  <th class="text-center">Terblokir</th>
                  <th class="text-center">Aktivitas Transaksi</th>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-center">
                    @if($user->is_banned == 0)
                    <span class="btn btn-primary py-2">No</span>
                    @else
                    <span class="btn btn-danger px-2 py-3 badge">Blocked</span><br>
                    <span class="btn btn-success px-2 py-3 mt-1">Activated</span>
                    @endif
                  </td>
                  @php
