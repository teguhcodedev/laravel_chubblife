<ul class="nav">
  <li class="nav-item nav-profile">
    <a href="#" class="nav-link">
      ...
      <div>
        ...
        <div style="font-size:43px;font-weight:bold"><h3>{{ auth()->user()->role }}</h3></div>
        <p>xnjznx</p>
      </div>
    </a>
  </li>
  ...
  <li class="nav-item">
    <a class="nav-link" data-toggle="collapse" href="#kelola_akun" aria-expanded="false" aria-controls="kelola_akun">
      <span class="menu-title">Kelola Akunss</span>
  ...
  <li class="nav-item">
    <a class="nav-link" data-toggle="collapse" href="#kelola_akun" aria-expanded="false" aria-controls="kelola_akun">
      <span class="menu-title">Kelola Customer</span>
      <i class="menu-arrow"></i>
    </a>
    <div class="collapse" id="kelola_akun">
      <ul class="nav flex-column sub-menu">
  ...
  <li class="nav-item">
    ...
    <div class="collapse" id="kelola_laporan">
      <ul class="nav flex-column sub-menu">
        <li class="nav-item">
          <a class="nav-link" href="{{ url('/report/transaction')  }}">Laporan Transaksiiio</a>
        </li>
        <li class="nav-item">
