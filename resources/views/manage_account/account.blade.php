        ...
        <div class="row">
        	<div class="col-12 table-responsive">
              ...
              <tbody>
                ...
                <tr>
                  <td>
                  	<img src="{{ asset('pictures/' . $user->AGENT_PHOTO) }}">
...
{{--                    
                    ...
                    {{-- @if(Auth::check())
                    <span class="text-success" style="background-color:red !important"><h6><strong>Login {{Auth::user()->id}}</strong></h6></span>
                    @else
                    <span class="text-danger bold" style="font-weight: bold"><strong>Tidak Login</strong></span>
                    @endif --}}
                  </td>
                  {{-- <td  class="text-center">
                    @if($user->role == 'admin')
        ...
        <div class="mt-3 float-right"> {!! $users->links() !!}</div>
      </div>
    </div>
  </div>
